...
class Merger(Operation):
    ...
    '''
    Taking as attributes two pd.DataFrame, its execute method returs their merging, using the merge function. It is possible to specify columns not to consider when merging the two dataFrames.
    '''
...
class Top10(Operation):
    ...
    '''
    Taking as attributes two pd.DataFrame, it returns the 10 most repeated lines of the selected columns. It is possible to specify columns not to consider when merging the two dataFrames.
    '''
...
class Associations(RetrieveColumnCondition):
    ...
    '''
    Taking as attributes two pd.DataFrame, it merges them. From this new DataFrame, it returns the lines complying to specific conditions of the selected columns. It is possible to specify columns not to consider when merging the two dataFrames.
    '''
